...
*what is container machine for, and does it manage or run my other containers?* 

Short answer: a container machine is its own thing — a persistent Linux workspace, not a controller for your containers. This note explains the distinction and when to reach for each.
